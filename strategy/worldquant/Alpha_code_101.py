...
import numpy as np
import pandas as pd
from .comm import correlation, covariance, decay_linear, delay, delta, product, rank, \
    scale, sma, stddev, ts_argmax, ts_argmin, ts_max, ts_min, ts_rank, ts_sum
...
class Alphas(object):
    def __init__(self, df_data: pd.DataFrame):
        ...
        self.returns = df_data['close'].pct_change()
