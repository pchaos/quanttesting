...
http://www.backtrader.net/index.php/backtrader/8-quickstart
"""
import datetime
import os
import sys
...
class TestStrategy5(bt.Strategy):
    params = (
        ('maperiod', 15),
        ('printlog', False),
    )
...
class test_backertrader(TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.dataFrame = cls._getDataframe()
    ...
    def test_strategy1(self):
        self._strategytest(TestStrategy1)

    def _strategytest(self, strategy=None):
        # Create a cerebro entity
        cerebro = bt.Cerebro()
        # Add a strategy
    ...
    def _getDataframe(cls):
        data = yf.download('orcl')
        data = bt.feeds.PandasData(dataname=data)
        return data

    def test_strategy2(self):
        self._strategytest(TestStrategy2)

    def test_strategy3(self):
        self._strategytest(TestStrategy3)

    def test_strategy4(self):
        self._strategytest(TestStrategy4)
